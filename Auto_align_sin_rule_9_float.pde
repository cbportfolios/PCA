...
// I have made no attempt to achieve hardware-accelerated rendering (e.g. with OpenGL).
// This is because the program is mainly an exercise in implementing maths for graphics programming.
